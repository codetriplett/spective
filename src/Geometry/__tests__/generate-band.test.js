...
describe('generate-band', () => {
	...
	it('should generate middle band with surrounding image', () => {
		...
		expect(actual).toBe([
			...
			'vt -0.16666666666666669 0.75',
			'v 0.43301270189221935 0.25 -0.24999999999999994',
			'vt 0.16666666666666663 0.75',
			'v -0.43301270189221924 0.25 -0.25000000000000017',
			'vt 0.5 0.75',
			'f 7/9 4/5 8/10',
			'f 5/6 8/10 4/5',
			'f 8/10 5/6 9/11',
